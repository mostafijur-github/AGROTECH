...
<html>
	<head>
		<title>AGROTECH FarmersPortal: Blogs</title>
		<meta charset="utf-8" />
					...
					<div class="container" style="width: 70%">
						...
						<div class="box">
							...
							<blockquote>
								...
								<br /> <br>
								<p>
									<h4><?php echo $row['blogUser']; ?></h4>
									<h5><?php echo $row['blogTime']; ?></h5>
								</p>
							...
							<form method="post" action="blogView.php">
								<div class="row">
									...
									<div class="6u 12u$(xsmall)">
										<span class="glyphicon glyphicon-pencil"></span> Comments : <?php $numComment ?></button>
									</div>
									<div class="12u$">
										<br>
							...
							?>
								<div class="con darker">
									<img src="<?php echo 'images/profileImages/'.$row1['commentPic']?>" alt="Avatar"><span><em><?php $row1['commentUser']; ?></em></span>
									<br>
