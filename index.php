		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>FarmersPortal</h2>
						<p>Explore the new way of Buying and Selling</p>
					</header>
					<div class="row 200%">
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-clock-o"></i>
							<p><button onclick="window.location.href='market.php'">Digital Market</button></p>
						</section>
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-comments"></i>
							<p><button onclick="window.location.href='blogView.php'">Farmers-Blog</button></p>
						</section>
						<section class="4u$ 12u$(small)">
							<i class="icon big rounded fa fa-line-chart"></i>
							<p><button onclick="window.location.href='#'">Market Price</button></p>
						</section>
					</div>
				</div>
			</section>
		   ...
		   <!-- <div class="logo">
			...
			<div class="footer-center">
				...
				<div>
					...
					<p style="font-size:20px"><a href="mailto:example@gmail.com" style="color:white">demo@demo.com</a></p>
				</div>
			</div>
			...
			<div class="footer-right">
				...
				<div class="footer-icons">
					<a  href="#"><i style="margin-left: 0;margin-top:5px;"class="fa fa-envelope"></i></a>
